...
const file_xai_api_v1_chat_proto_rawDesc = "" +
	"\n" +
	"\x15xai/api/v1/chat.proto\x12\axai_api\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19xai/api/v1/deferred.proto\x1a\x1axai/api/v1/documents.proto\x1a\x16xai/api/v1/image.proto\x1a\x17xai/api/v1/sample.proto\x1a\x16xai/api/v1/usage.proto\"\xed\t\n" +
	...
	"\x16DeleteStoredCompletion\x12&.xai_api.DeleteStoredCompletionRequest\x1a'.xai_api.DeleteStoredCompletionResponse\"\x00B\x84\x01\n" +
	"\vcom.xai_apiB\tChatProtoP\x01Z2github.com/roelfdiedericks/xai-go/proto/xai/api/v1\xa2\x02\x03XXX\xaa\x02\x06XaiApi\xca\x02\x06XaiApi\xe2\x02\x12XaiApi\\GPBMetadata\xea\x02\x06XaiApib\x06proto3"
...
var file_xai_api_v1_chat_proto_goTypes = []any{
	...
	(*WebSearchUserLocation)(nil),          // 30: xai_api.WebSearchUserLocation
	(*XSearch)(nil),                        // 31: xai_api.XSearch
	(*CodeExecution)(nil),                  // 32: xai_api.CodeExecution
	(*CollectionsSearch)(nil),              // 33: xai_api.CollectionsSearch
	(*AttachmentSearch)(nil),               // 34: xai_api.AttachmentSearch
	(*Function)(nil),                       // 35: xai_api.Function
	(*ToolCall)(nil),                       // 36: xai_api.ToolCall
	(*FunctionCall)(nil),                   // 37: xai_api.FunctionCall
	(*ResponseFormat)(nil),                 // 38: xai_api.ResponseFormat
	(*SearchParameters)(nil),               // 39: xai_api.SearchParameters
	(*Source)(nil),                         // 40: xai_api.Source
	(*WebSource)(nil),                      // 41: xai_api.WebSource
	(*NewsSource)(nil),                     // 42: xai_api.NewsSource
	(*XSource)(nil),                        // 43: xai_api.XSource
	(*RssSource)(nil),                      // 44: xai_api.RssSource
	(*RequestSettings)(nil),                // 45: xai_api.RequestSettings
	(*GetStoredCompletionRequest)(nil),     // 46: xai_api.GetStoredCompletionRequest
	(*DeleteStoredCompletionRequest)(nil),  // 47: xai_api.DeleteStoredCompletionRequest
	(*DeleteStoredCompletionResponse)(nil), // 48: xai_api.DeleteStoredCompletionResponse
	(*DebugOutput)(nil),                    // 49: xai_api.DebugOutput
	nil,                                    // 50: xai_api.MCP.ExtraHeadersEntry
	(*timestamppb.Timestamp)(nil),          // 51: google.protobuf.Timestamp
	(*SamplingUsage)(nil),                  // 52: xai_api.SamplingUsage
	(DeferredStatus)(0),                    // 53: xai_api.DeferredStatus
	(FinishReason)(0),                      // 54: xai_api.FinishReason
	(*ImageUrlContent)(nil),                // 55: xai_api.ImageUrlContent
	(*HybridRetrieval)(nil),                // 56: xai_api.HybridRetrieval
	(*SemanticRetrieval)(nil),              // 57: xai_api.SemanticRetrieval
	(*KeywordRetrieval)(nil),               // 58: xai_api.KeywordRetrieval
	(*GetDeferredRequest)(nil),             // 59: xai_api.GetDeferredRequest
	(*StartDeferredResponse)(nil),          // 60: xai_api.StartDeferredResponse
}
var file_xai_api_v1_chat_proto_depIdxs = []int32{
	...
	38, // 3: xai_api.GetCompletionsRequest.response_format:type_name -> xai_api.ResponseFormat
	2,  // 4: xai_api.GetCompletionsRequest.reasoning_effort:type_name -> xai_api.ReasoningEffort
	39, // 5: xai_api.GetCompletionsRequest.search_parameters:type_name -> xai_api.SearchParameters
	...
	51, // 8: xai_api.GetChatCompletionResponse.created:type_name -> google.protobuf.Timestamp
	52, // 9: xai_api.GetChatCompletionResponse.usage:type_name -> xai_api.SamplingUsage
	45, // 10: xai_api.GetChatCompletionResponse.settings:type_name -> xai_api.RequestSettings
	49, // 11: xai_api.GetChatCompletionResponse.debug_output:type_name -> xai_api.DebugOutput
	14, // 12: xai_api.GetChatCompletionChunk.outputs:type_name -> xai_api.CompletionOutputChunk
	51, // 13: xai_api.GetChatCompletionChunk.created:type_name -> google.protobuf.Timestamp
	52, // 14: xai_api.GetChatCompletionChunk.usage:type_name -> xai_api.SamplingUsage
	49, // 15: xai_api.GetChatCompletionChunk.debug_output:type_name -> xai_api.DebugOutput
	53, // 16: xai_api.GetDeferredCompletionResponse.status:type_name -> xai_api.DeferredStatus
	9,  // 17: xai_api.GetDeferredCompletionResponse.response:type_name -> xai_api.GetChatCompletionResponse
	54, // 18: xai_api.CompletionOutput.finish_reason:type_name -> xai_api.FinishReason
	...
	36, // 22: xai_api.CompletionMessage.tool_calls:type_name -> xai_api.ToolCall
	...
	54, // 26: xai_api.CompletionOutputChunk.finish_reason:type_name -> xai_api.FinishReason
	1,  // 27: xai_api.Delta.role:type_name -> xai_api.MessageRole
	36, // 28: xai_api.Delta.tool_calls:type_name -> xai_api.ToolCall
	...
	55, // 35: xai_api.Content.image_url:type_name -> xai_api.ImageUrlContent
	...
	36, // 39: xai_api.Message.tool_calls:type_name -> xai_api.ToolCall
	3,  // 40: xai_api.ToolChoice.mode:type_name -> xai_api.ToolMode
	35, // 41: xai_api.Tool.function:type_name -> xai_api.Function
	29, // 42: xai_api.Tool.web_search:type_name -> xai_api.WebSearch
	31, // 43: xai_api.Tool.x_search:type_name -> xai_api.XSearch
	32, // 44: xai_api.Tool.code_execution:type_name -> xai_api.CodeExecution
	33, // 45: xai_api.Tool.collections_search:type_name -> xai_api.CollectionsSearch
	28, // 46: xai_api.Tool.mcp:type_name -> xai_api.MCP
	34, // 47: xai_api.Tool.attachment_search:type_name -> xai_api.AttachmentSearch
	50, // 48: xai_api.MCP.extra_headers:type_name -> xai_api.MCP.ExtraHeadersEntry
	30, // 49: xai_api.WebSearch.user_location:type_name -> xai_api.WebSearchUserLocation
	51, // 50: xai_api.XSearch.from_date:type_name -> google.protobuf.Timestamp
	51, // 51: xai_api.XSearch.to_date:type_name -> google.protobuf.Timestamp
	56, // 52: xai_api.CollectionsSearch.hybrid_retrieval:type_name -> xai_api.HybridRetrieval
	57, // 53: xai_api.CollectionsSearch.semantic_retrieval:type_name -> xai_api.SemanticRetrieval
	58, // 54: xai_api.CollectionsSearch.keyword_retrieval:type_name -> xai_api.KeywordRetrieval
	5,  // 55: xai_api.ToolCall.type:type_name -> xai_api.ToolCallType
	6,  // 56: xai_api.ToolCall.status:type_name -> xai_api.ToolCallStatus
	37, // 57: xai_api.ToolCall.function:type_name -> xai_api.FunctionCall
	4,  // 58: xai_api.ResponseFormat.format_type:type_name -> xai_api.FormatType
	7,  // 59: xai_api.SearchParameters.mode:type_name -> xai_api.SearchMode
	40, // 60: xai_api.SearchParameters.sources:type_name -> xai_api.Source
	51, // 61: xai_api.SearchParameters.from_date:type_name -> google.protobuf.Timestamp
	51, // 62: xai_api.SearchParameters.to_date:type_name -> google.protobuf.Timestamp
	41, // 63: xai_api.Source.web:type_name -> xai_api.WebSource
	42, // 64: xai_api.Source.news:type_name -> xai_api.NewsSource
	43, // 65: xai_api.Source.x:type_name -> xai_api.XSource
	44, // 66: xai_api.Source.rss:type_name -> xai_api.RssSource
	2,  // 67: xai_api.RequestSettings.reasoning_effort:type_name -> xai_api.ReasoningEffort
	38, // 68: xai_api.RequestSettings.response_format:type_name -> xai_api.ResponseFormat
	26, // 69: xai_api.RequestSettings.tool_choice:type_name -> xai_api.ToolChoice
	27, // 70: xai_api.RequestSettings.tools:type_name -> xai_api.Tool
	39, // 71: xai_api.RequestSettings.search_parameters:type_name -> xai_api.SearchParameters
	0,  // 72: xai_api.RequestSettings.include:type_name -> xai_api.IncludeOption
	8,  // 73: xai_api.Chat.GetCompletion:input_type -> xai_api.GetCompletionsRequest
	8,  // 74: xai_api.Chat.GetCompletionChunk:input_type -> xai_api.GetCompletionsRequest
	8,  // 75: xai_api.Chat.StartDeferredCompletion:input_type -> xai_api.GetCompletionsRequest
	59, // 76: xai_api.Chat.GetDeferredCompletion:input_type -> xai_api.GetDeferredRequest
	46, // 77: xai_api.Chat.GetStoredCompletion:input_type -> xai_api.GetStoredCompletionRequest
	47, // 78: xai_api.Chat.DeleteStoredCompletion:input_type -> xai_api.DeleteStoredCompletionRequest
	9,  // 79: xai_api.Chat.GetCompletion:output_type -> xai_api.GetChatCompletionResponse
	10, // 80: xai_api.Chat.GetCompletionChunk:output_type -> xai_api.GetChatCompletionChunk
	60, // 81: xai_api.Chat.StartDeferredCompletion:output_type -> xai_api.StartDeferredResponse
	11, // 82: xai_api.Chat.GetDeferredCompletion:output_type -> xai_api.GetDeferredCompletionResponse
	9,  // 83: xai_api.Chat.GetStoredCompletion:output_type -> xai_api.GetChatCompletionResponse
	48, // 84: xai_api.Chat.DeleteStoredCompletion:output_type -> xai_api.DeleteStoredCompletionResponse
