...
const file_xai_api_v1_image_proto_rawDesc = "" +
	"\n" +
	"\x16xai/api/v1/image.proto\x12\axai_api\x1a\x16xai/api/v1/usage.proto\"\xf7\x02\n" +
	...
	"\x05Image\x12H\n" +
	"\rGenerateImage\x12\x1d.xai_api.GenerateImageRequest\x1a\x16.xai_api.ImageResponse\"\x00B\x85\x01\n" +
	"\vcom.xai_apiB\n" +
	"ImageProtoP\x01Z2github.com/roelfdiedericks/xai-go/proto/xai/api/v1\xa2\x02\x03XXX\xaa\x02\x06XaiApi\xca\x02\x06XaiApi\xe2\x02\x12XaiApi\\GPBMetadata\xea\x02\x06XaiApib\x06proto3"
...
var file_xai_api_v1_image_proto_depIdxs = []int32{
	...
	7, // 4: xai_api.ImageResponse.images:type_name -> xai_api.GeneratedImage
	9, // 5: xai_api.ImageResponse.usage:type_name -> xai_api.SamplingUsage
	0, // 6: xai_api.ImageUrlContent.detail:type_name -> xai_api.ImageDetail
	5, // 7: xai_api.Image.GenerateImage:input_type -> xai_api.GenerateImageRequest
	6, // 8: xai_api.Image.GenerateImage:output_type -> xai_api.ImageResponse
