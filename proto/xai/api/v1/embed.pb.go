...
const file_xai_api_v1_embed_proto_rawDesc = "" +
	...
	"\bEmbedder\x128\n" +
	"\x05Embed\x12\x15.xai_api.EmbedRequest\x1a\x16.xai_api.EmbedResponse\"\x00B\x85\x01\n" +
	"\vcom.xai_apiB\n" +
	"EmbedProtoP\x01Z2github.com/roelfdiedericks/xai-go/proto/xai/api/v1\xa2\x02\x03XXX\xaa\x02\x06XaiApi\xca\x02\x06XaiApi\xe2\x02\x12XaiApi\\GPBMetadata\xea\x02\x06XaiApib\x06proto3"
